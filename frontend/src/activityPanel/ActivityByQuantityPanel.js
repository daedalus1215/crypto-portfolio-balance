...
import { aggregateQuantityByDayAcrossMultipleDays } from "../home/utilities";
...
const ActivityByQuantityPanel = ({ selectedPortfolio }) => {
    ...
    useEffect(() => {
        let totalAmount = aggregateQuantityByDayAcrossMultipleDays(activity, instrumentHistory);
        ...
        const lineGraphData = {
            ...
            datasets: [
                {
                    data: totalAmount,
                    label: `Quantity of ${name} (${code.toUpperCase()})`,
                    borderColor: color,
                    fill: false,
                },
            ],
...
export default ActivityByQuantityPanel;